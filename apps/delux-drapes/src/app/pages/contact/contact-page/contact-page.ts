...
import { PhoneFormatPipe } from "../../../../../../../libs/atlas/core/src/lib/phone-format.pipe";

@Component({
  selector: 'main',
  templateUrl: 'contact-page.html',
  styleUrls: ['contact-page.scss'],
  imports: [ScrollLink, BreadcrumbsHeader, WayWeWorkComponent, MainHeaderComponent, MainFooterComponent, PhoneFormatPipe],
