...
// Сгенерировано tools/mockups/site-to-angular.mjs из mockups/site/catalog/curtain-rods/9/index.html
@Component({
  selector: 'app-catalog-curtain-rods-9-page',
...
export class CatalogCurtainRods9Page {}
