...
// Сгенерировано tools/mockups/site-to-angular.mjs из mockups/site/catalog/pleated-blinds/index.html
@Component({
  selector: 'app-catalog-pleated-blinds-page',
