...
// Сгенерировано tools/mockups/site-to-angular.mjs из mockups/site/catalog/curtain-rods/1/index.html
@Component({
  selector: 'app-catalog-curtain-rods-1-page',
...
export class CatalogCurtainRods1Page {}
