...
// Сгенерировано tools/mockups/site-to-angular.mjs из mockups/site/catalog/curtain-rods/2/index.html
@Component({
  selector: 'app-catalog-curtain-rods-2-page',
...
export class CatalogCurtainRods2Page {}
