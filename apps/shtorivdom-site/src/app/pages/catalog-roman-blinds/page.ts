...
@Component({
  selector: 'app-catalog-roman-blinds-page',
...
export class CatalogRomanBlindsPage {
  protected readonly faq = SITE_FAQ;
  protected readonly priceSection = SITE_PRICES.find((section) => section.key === 'roman-blinds')!;
}
