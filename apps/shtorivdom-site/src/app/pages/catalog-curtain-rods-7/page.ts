...
// Сгенерировано tools/mockups/site-to-angular.mjs из mockups/site/catalog/curtain-rods/7/index.html
@Component({
  selector: 'app-catalog-curtain-rods-7-page',
...
export class CatalogCurtainRods7Page {
