...
import { DemoInlineComponent } from './inline.component';

const meta: Meta<DemoInlineComponent> = {
  title: 'Inline Editor',
  component: DemoInlineComponent,
  decorators: [
    moduleMetadata({
...
type Story = StoryObj<DemoInlineComponent>;
