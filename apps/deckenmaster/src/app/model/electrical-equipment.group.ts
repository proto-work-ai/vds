...
export const electricalEquipmentGroup: UnitPrice[] = [
  { name: 'Светодиодная лента SMD высокоэффективная 24В ip20', unit: PriceUnit.LM, price: 500 },
  { name: '80д/м, 6Вт, (3000,4000,6000К)', unit: PriceUnit.LM, price: 1100 },
...
export const powerSuppliesGroup: UnitPrice[] = [
  ...
  { name: '200 Ватт, 24В', unit: PriceUnit.Things, price: 2490 },
] as const;
