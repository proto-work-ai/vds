...
export class Detail {
  ...
  protected readonly services = signal<{ title: string; image: string; text: string }[]>([
    ...
    },
    {
      ...
      text: `Острые предметы, выступы, зазоры на багете, не замеченные при натяжке полотна. Повреждение при монтаже. Брак полотна.`,
      image: '/services/repair/image-5.jpg',
    },
    {
      title: `Разрыв в области трубы`,
      text: `Некачественный обвод трубы и его установка при монтаже. Недостаток клея. Воздействие температур на полотно. Повреждение при установке.`,
  ...
  protected readonly works = signal<{ title: string; text: string }[]>([
    {
      ...
      text: `Свяжитесь с нами или отправьте фото повреждения. Менеджер оценит ситуацию за 15 минут и подскажет примерную стоимость ремонта натяжного потолка.`,
    },
    {
      title: 'Выезд мастера',
    ...
    // { title: 'Подготовка', text: `При необходимости частично демонтируем натяжное полотно.` },
    {
      ...
      text: `Устраняем дефект: выполняем слив воды после затопления, устраняем порез заплаткой или перетягиваем полотно. Для ремонта натяжных потолков после пореза цена зависит от размера, но мы всегда фиксируем ее в договоре.`,
    },
    {
