    ...
    template: `
      <div class="wrap space-y-10 py-10">
        ...
        <section class="space-y-3">
          ...
          <p class="max-w-[640px] text-[14px] leading-[1.8] font-light text-slate">Абзац секции — 16px, 300, leading 1.8. Вся продукция изготавливается по индивидуальным размерам из качественных материалов.</p>
          <p class="text-[14px] leading-relaxed text-slate/80">Текст шагов — 15px, slate/80</p>
