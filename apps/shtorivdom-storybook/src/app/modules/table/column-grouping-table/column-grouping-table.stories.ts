...
import { AtlasColumnGroupingTable } from './column-grouping-table';

const meta: Meta<AtlasColumnGroupingTable> = {
  component: AtlasColumnGroupingTable,
...
type Story = StoryObj<AtlasColumnGroupingTable>;
